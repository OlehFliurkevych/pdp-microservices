...
public class MessageScheduler {
  ...
  public void callMicroRecipient() {
    log.info("Scheduled call GET 'micro-recipient/message/remove'");
    var response = microRecipientFeignClient.getAndRemoveSingleNotification();

    if (response.getStatusCode().is2xxSuccessful()) {
      log.info("Successfully called GET 'micro-recipient/message/remove'. Body of response: [{}]",
        response.getBody());
      ...
      log.info("Failed call GET 'micro-recipient/message/remove'");
    }
  }
